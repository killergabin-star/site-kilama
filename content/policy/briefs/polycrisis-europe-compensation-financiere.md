---
title: 'Europe : la souveraineté à l''épreuve des dépendances'
subtitle: 'Compensation financière, chaînes industrielles et le paradoxe ReArm'
date: '2026-04-14'
doc_type: brief
theme: polycrisis
status: ready
...
- **Le paradoxe ReArm.** L'Europe finance son autonomie stratégique (800 milliards d'euros à l'horizon 2030) avec des outils dont la disponibilité dépend en partie de la contrepartie qu'elle cherche à réduire. La dépendance finance l'autonomie ; tant que les deux canaux critiques — compensation financière et chaînes industrielles de défense — ne sont pas internalisés, la souveraineté européenne est une politique menée dans une architecture qu'elle ne contrôle pas entièrement.
- **Première dépendance — la compensation financière (invisible dans les bilans).** De l'ordre de **700 à 900 milliards de dollars** d'actifs américains détenus par des investisseurs européens transitent par Euroclear (Belgique) et les dépositaires luxembourgeois. Ce nœud forme un goulet d'étranglement pour la chaîne collatérale de la zone euro, de deux manières distinctes : un **risque opérationnel concentré** (panne, cyberattaque, défaillance technique) sur un maillon critique du post-marché ; et un **risque de coercition réglementaire** qui opère non sur la localisation belge du dépositaire, mais sur la nature américaine du sous-jacent — *executive order*, liste OFAC, révision FATCA. Les deux canaux doivent être traités séparément dans la cartographie prudentielle.
- **Seconde dépendance — les chaînes industrielles de défense (calendriers différenciés).** Les capacités critiques se reconstituent sur des horizons hétérogènes : **munitions de précision 18 à 36 mois**, **défense sol-air longue portée (SAMP/T, successeur Patriot) 7 à 10 ans**, capacités spatiales 5 à 8 ans. Les engagements 2025-2026 produiront des livraisons significatives à partir de 2028 pour les segments courts, à partir de 2030-2033 pour les segments longs. Pendant cette transition, les deux dépendances se cumulent.
- **Conséquence pour la cartographie du risque souverain européen.** Les nœuds de post-marché deviennent variable de premier ordre, non sujet technique réservé aux superviseurs sectoriels. La supervision unique européenne, qui a solidifié les bilans bancaires depuis 2014, n'a pas construit de discipline équivalente sur les infrastructures de marché.
...
- **Spreads BTP-Bund et OAT-Bund**. Seuil d'alerte : 200 points de base. Seuil critique : 300 points de base.
- **Volume quotidien de règlements Euroclear** et ratio d'utilisation des lignes de crédit intra-journalières. Un stress opérationnel se traduirait par une hausse brutale du ratio.
- **Taux d'exécution cumulé ReArm Europe** (mensuel). Un retard significatif par rapport à la trajectoire 2030 signale un arbitrage budgétaire national défavorable.
- **Écart entre rendements euro / dollar sur fonds souverains européens émis sur le marché américain**. Un élargissement signale une perception différenciée du risque selon la devise de libellé.

---

## Prolongement

Ce numéro spécial prolonge les chapitres 3 (Finance) et 4 (Sécurité et alliances) du rapport *La convergence des crises*, en se concentrant sur une vulnérabilité européenne spécifique que le rapport mère documente mais ne met pas au premier plan. Pour la cartographie complète des asymétries Nord-Sud et des options différenciées par acteur, voir [le rapport mère](/policy/reports/convergence-polycrisis/).
...
[^1]: AIE (2024). *Gas Market Report, Q4 2024*. La reconfiguration du mix énergétique européen depuis 2022 a déplacé la vulnérabilité plutôt qu'elle ne l'a éliminée.

[^2]: Maggiori, M., Neiman, B. et Schreger, J. (2021). « Redrawing the Map of Global Capital Flows », *Quarterly Journal of Economics*, 136(1), 43-97.

[^3]: *La convergence des crises*, Partie II, chapitre 3. L'estimation de 827 Md$ combine les données du Trésor américain (TIC System), les positions Coordinated Portfolio Investment Survey du FMI et la cartographie Maggiori-Neiman-Schreger.

[^4]: Comité européen du risque systémique (2019). *Systemic cyber risk*. La désignation des dépositaires centraux comme infrastructures critiques date du règlement CSDR (2014) et de sa révision 2023.

[^5]: Commission européenne (2025). *ReArm Europe Plan / Readiness 2030*.

[^6]: Estimation par convention de taux actualisé sur la maturité moyenne du financement ReArm (7-10 ans). Le calcul est documenté dans *La convergence des crises*, Partie II, chapitre 4.

[^7]: European Defence Agency (2024). *Coordinated Annual Review on Defence (CARD)*. Le rapport documente les capacités critiques dont la reconstitution requiert des délais de 5 à 8 ans.

[^8]: Une cartographie sectorielle européenne des enchaînements de rétroaction dédiée aux infrastructures de post-marché serait une extension utile du cadre d'analyse. Elle n'est pas incluse dans le rapport intégrateur.
