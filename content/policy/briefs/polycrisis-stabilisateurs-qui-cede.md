...
- **Trois freins automatiques neutralisés en même temps** : le dollar ne peut plus s'ajuster librement, les marges budgétaires européennes sont préemptées par le réarmement, la coordination multilatérale est fragilisée. Les trois mécanismes qui ont joué successivement en 2008, 2015 et 2022 sont ensemble désactivés.
- **Contraste avec les trois polycrises récentes** : chacune conservait au moins un mécanisme correcteur actif (chute des matières premières en 2008, reprise européenne en 2015, substitution GNL en 2022). 2026 est la première depuis la fin de la Guerre froide à n'en avoir aucun.
- **La stabilisation devient politique, non mécanique.** Elle ne se produit plus d'elle-même ; elle doit être décidée, coordonnée, financée. L'inaction n'est plus une option neutre, c'est le choix d'une trajectoire défavorable.
- **Conséquence opérationnelle** : l'hypothèse implicite des prévisions macroéconomiques standards — retour à la moyenne après choc — n'est plus tenable. Les modèles sous-estiment systématiquement les queues de distribution.
