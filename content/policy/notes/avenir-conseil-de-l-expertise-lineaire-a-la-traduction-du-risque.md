---
title: "L'avenir du conseil : de l'expertise linéaire à la traduction du risque"
date: '2026-07-11'
doc_type: note
...
![Quatre grammaires du risque selon la géographie du siège : postures des entreprises américaines, européennes, chinoises et indiennes](/uploads/figures/business/conseil_grammaires.svg)
...
- L'IA banalise la **couche linéaire** du conseil — collecte, benchmark, synthèse, mise en récit — et risque, si elle n'est pas gouvernée, d'industrialiser la doxa que Gomart et Pont (Ifri, avril 2025) décrivent comme linéaire, dépersonnalisée et partiale. La valeur se réfugie dans ce qui rompt avec la linéarité.

- Le risque n'est ni exogène ni uniforme : il se formule selon une double géographie — siège et opérations — et prend des formes sectorielles distinctes (Gomart et Mielle, Ifri, mai 2026). Il n'existe donc pas de réponse générique ; la valeur du conseil se loge dans la **spécificité**.

- L'exposition aux chocs est partagée à toutes les échelles — plus d'un tiers des entreprises manufacturières allemandes dépendent d'intrants critiques importés (CEPR, mai 2024) —, mais l'instrumentation manque en dessous des très grands comptes. Le conseil augmenté de proximité comble cet angle mort des ETI et des PME.

- La profession de l'audit et de l'expertise comptable, forte de la relation récurrente, de la donnée financière et de la confiance de proximité, est la mieux placée pour porter cette traduction ; elle a déjà normé le risque climatique via le reporting de durabilité et peut faire le même chemin sur le risque géopolitique et les risques convergents.

- La géopolitique est redevenue une variable structurelle de l'économie — non plus un aléa exogène affectant les marges à la marge, mais une donnée permanente de gestion. Sa **traduction en décision**, discipline exigeante autant que rare, sera le cœur du conseil de la décennie : la valeur se logera là, et non dans le diagnostic que l'automatisation rend désormais gratuit.
