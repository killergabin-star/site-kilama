---
title: 'Choc Ormuz et sécurité alimentaire en Afrique subsaharienne : quatre canaux, un calendrier'
date: '2026-04-20'
doc_type: note
tags:
...
- Évian
- spring-meetings
summary: Le blocus du détroit d'Ormuz déclenche un choc alimentaire à retardement sur l'Afrique
  subsaharienne via quatre canaux convergents. Le choc se matérialise au second semestre 2026, dans
  une fenêtre où les amortisseurs traditionnels sont au plus bas historique.
status: ready
draft: false
theme: geopolitics-economics
author: Eric Gabin Kilama
thumbnail:
  strategy: custom
  style: dalle-original
  custom_path: thumbnails/custom/dalle-original/notes-choc-ormuz-securite-alimentaire-afrique.png
---
...
- Le diesel agricole renchérit les coûts de production et de transport
- Dans les pays sahéliens enclavés (Mali, Burkina, Niger, Tchad), le prix du carburant se transmet directement aux prix alimentaires urbains
- Les subventions énergétiques, là où elles existent, compriment les budgets déjà sous pression
...
- **Dépréciation monétaire** : le rand sud-africain a perdu 5-7 % ; les monnaies est-africaines subissent une pression comparable
- **Taux directeurs** : la plupart des banques centrales africaines ont suspendu les baisses de taux attendues, comprimant la demande intérieure
- **Inflation importée** : le choc pétrolier combiné à la dépréciation crée une double pression sur les prix à la consommation
- **Fret maritime** : les tarifs spot Asie-Méditerranée ont atteint **8 500 $/FEU** avec surcharges de guerre, renchérissant toutes les importations

### Canal 4 — Aide (effondrement simultané des amortisseurs)

Ce choc alimentaire intervient au pire moment :

- APD bilatérale vers l'Afrique : **−26,3 %** en 2025
- Aide humanitaire : **−42 %** en 2025
- PAM : −34 % de financement prévu ; UNICEF : −27 % ; OMS : −39 %
- Moins de la moitié des personnes en besoin d'aide humanitaire peuvent être couvertes en 2026
- 83 % des programmes USAID terminés
