---
title: "L'entreprise européenne face au choc énergétique : Ormuz, GNL et le compte de résultat"
date: 2026-07-12
doc_type: report
theme: business
tags:
...
- chaines-de-valeur
- stress-test
summary: "Un blocage sur Ormuz et la bascule vers un GNL rare ne sont pas un événement de la page géopolitique : ils migrent, ligne à ligne, jusqu'au compte de résultat. Ce dossier traite le risque énergétique comme le ferait un département risque — mécanisme de transmission (prix de l'énergie → coûts d'intrants → marge), carte d'exposition sectorielle (chimie, métallurgie, verre-ciment, transport), et un enseignement décisif : l'exposition est sectorielle, mais l'incidence se décide au bilan. Sur données d'entreprises européennes, la part des firmes qui répercutent une hausse de coûts passe de 17,6 % (micro) à 40,0 % (grandes) — un gradient de taille qui déplace la compression de marge vers les PME et ETI."
status: staging
draft: false
...
- **Le besoin en fonds de roulement.** Un choc énergétique gonfle stocks et créances. Le levier de résistance est la capacité à financer cette hausse sans rupture de trésorerie — donc le niveau de liquidités et l'accès au crédit court terme.
- **La couverture.** Les contrats d'achat d'énergie à prix fixe et les instruments de couverture déplacent l'exposition du prix vers le risque de contrepartie et le risque de base. Ils protègent les firmes qui y ont accès — c'est-à-dire, très inégalement, les plus grandes. Une PME est rarement couverte au-delà de quelques mois.
- **Le capex de résilience.** L'électrification et l'efficacité énergétique réduisent structurellement l'exposition, mais mobilisent un capital que les firmes contraintes en trésorerie ne peuvent engager au moment où il serait le plus utile — un effet de sélection adverse qui creuse l'écart entre grandes et petites au fil des chocs successifs.
...
**25.** Une entreprise interrogée dans le cadre de l'*Allianz Risk Barometer* place désormais l'interruption d'activité et les risques énergétiques et géopolitiques parmi ses préoccupations de premier rang[^11] — confirmation que ces signaux ne relèvent pas d'une veille exotique mais de la gestion de risque courante. L'enjeu n'est pas de les découvrir, mais de les **ordonner** selon le canal de transmission, pour transformer une collection d'indicateurs en système d'alerte précoce : un signal amont (prix du gaz) qui se propage jusqu'à un signal aval (allongement des délais de paiement chez les PME de la chimie) trace, en temps réel, le trajet du risque à travers le bilan.
...
[^11]: *Allianz Risk Barometer*, édition 2026 : l'interruption d'activité, les risques énergétiques et les risques politiques et géopolitiques figurent parmi les principaux risques cités par les entreprises interrogées.
