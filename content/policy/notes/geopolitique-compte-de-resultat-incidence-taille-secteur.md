---
title: 'Quand la géopolitique entre dans le compte de résultat : incidence par taille et par secteur'
date: '2026-07-11'
doc_type: brief
...
- **Marge brute** : c'est la première ligne à bouger, et la plus visible. La fraction non répercutée du choc s'y loge intégralement. Un choc d'intrant modéré peut y effacer plusieurs points de marge en un seul exercice.
- **Excédent brut d'exploitation et résultat d'exploitation** : la compression de marge brute s'y propage mécaniquement, d'autant que les charges fixes (loyers, salaires, énergie de site) ne s'ajustent pas au rythme du choc.
- **Besoin en fonds de roulement (BFR)** : c'est le canal le plus insidieux. Face à l'incertitude d'approvisionnement, l'entreprise reconstitue des stocks de sécurité et diversifie ses fournisseurs (hausse des stocks) ; ses fournisseurs, eux-mêmes sous tension, raccourcissent leurs délais de paiement ou exigent des acomptes (baisse des dettes fournisseurs) ; ses clients, prudents, allongent les leurs (hausse des créances clients). Les trois mouvements gonflent le BFR simultanément.
...
- **Marge brute.** Premier signal, à suivre trimestre après trimestre. Une érosion qui ne s'explique ni par le mix produit ni par un effet volume, mais par le coût des intrants, est la signature d'un choc absorbé faute de pouvoir être répercuté.
- **Besoin en fonds de roulement et ses composantes.** Suivre séparément les jours de stock, les délais clients et les délais fournisseurs. Un gonflement simultané des trois est le marqueur d'une entreprise qui reconstitue des stocks de sécurité tout en perdant du levier de négociation des deux côtés de sa chaîne.
- **Trésorerie et structure de financement.** Surveiller le tirage sur les lignes court terme, la maturité résiduelle de la dette et l'horizon de liquidité. Un BFR croissant financé à court terme est une combinaison fragile en environnement de taux incertain.
- **Couverture.** Documenter la part du coût des intrants et des expositions de change effectivement couverte, ainsi que la durée résiduelle des contrats d'approvisionnement. L'absence de couverture est ce qui sépare, à choc égal, la PME qui absorbe de la grande entreprise qui transfère.
- **Concentration fournisseurs.** Mesurer la part du premier fournisseur et du premier pays d'origine, y compris au-delà du rang 1, et repérer l'exposition à un goulet logistique unique. C'est l'indicateur le plus prédictif de la vulnérabilité géopolitique réelle.
- **Reporting extra-financier et contrôle interne.** La directive CSRD, avec son principe de double matérialité, offre un cadre pour formaliser l'exposition aux ruptures d'approvisionnement d'origine géopolitique. Bien tenu, ce reporting cesse d'être une contrainte de conformité pour devenir un instrument de pilotage du risque.
- **Provisions et coût du risque.** Dernière ligne à bouger, mais celle qui matérialise tout le reste. Une hausse du coût du risque concentrée sur les segments PME les plus exposés confirme, a posteriori, que le choc géopolitique a bien traversé toute la chaîne — du prix de l'intrant à la perte de crédit.
...
- Le risque géopolitique est l'une des toutes premières préoccupations déclarées des directeurs financiers français (63 %, au 2e rang derrière l'inflation), mais 11 % seulement des entreprises disposent d'une fonction dédiée : l'écart entre la perception et l'outillage définit le besoin.[^2]
- L'incidence d'un choc géopolitique n'est pas homogène. Parmi les entreprises confrontées à une hausse de coûts, 17,6 % seulement des micro et petites entreprises la répercutent sur leurs prix, contre 40,0 % des grandes (enquête SAFE) : un différentiel de près de vingt-trois points dans la part des firmes qui relèvent leurs prix.
- Chez les firmes qui n'ajustent pas leurs prix — la grande majorité des PME —, le coût non répercuté ne disparaît pas ; il se loge dans la marge brute puis dans le besoin en fonds de roulement, transformant un événement de compte de résultat en événement de bilan à retardement.
- L'exposition sectorielle se concentre là où intensité d'importation et concentration des intrants se rencontrent : industries de transformation, intrants critiques, secteurs sensibles aux goulets logistiques.
- Pour un portefeuille de crédit PME, le choc déplace la probabilité de défaut de façon corrélée à la fragilité préexistante : la stratification taille × secteur, l'*overlay* géopolitique dans le provisionnement prospectif et l'indicateur de dépendance d'approvisionnement au niveau de l'emprunteur deviennent des préalables.
- Six indicateurs rendent le risque suivable avant qu'il ne devienne une provision : marge brute, BFR, trésorerie, couverture, concentration fournisseurs, reporting CSRD.

---

[^1]: Thomas Gomart et Siméo Pont, *La fabrique du risque : les entreprises face à la doxa géopolitique*, Institut français des relations internationales (IFRI), avril 2025.
[^2]: Deloitte, *CFO Survey France*, printemps 2025 ; les mêmes vagues situent à 90 % la part des directeurs financiers européens plaçant le risque géopolitique dans leur trio de tête.
[^3]: Allianz, *Allianz Risk Barometer* (édition annuelle) ; BlackRock, *Geopolitical Risk Indicator* (BGRI). Ces instruments mesurent respectivement la perception des gestionnaires de risque et l'attention des marchés, non l'incidence au niveau de la firme.
[^4]: Estimations de l'auteur sur un panel de quarante-quatre pays exportateurs, 1995-2024, à partir de l'indice de risque géopolitique de Dario Caldara et Matteo Iacoviello (« Measuring Geopolitical Risk », *American Economic Review*, 2022), qui mesure l'intensité de la couverture médiatique des tensions géopolitiques et non le risque objectif. Résultat stable pour deux constructions indépendantes de l'indice.
[^5]: Données publiques de l'US Geological Survey (*Mineral Commodity Summaries*) et de l'Agence internationale de l'énergie ; hausse du prix de l'antimoine consécutive aux restrictions chinoises à l'exportation, 2024.
[^6]: Centre for Economic Policy Research (CEPR) et Commission européenne, travaux sur les dépendances d'approvisionnement européennes ; plusieurs centaines de produits en forte dépendance externe, pour un impact potentiel de plusieurs points de PIB de l'Union en cas de rupture.
[^7]: Estimations de l'auteur, *La convergence des crises* (2026, disponible sur erickilama.com) : la transmission des chocs géopolitiques opère par effet de seuil, l'activation simultanée de plusieurs canaux démultipliant les multiplicateurs.
