---
title: 'Noter l''exposition géo-économique d''une entreprise : une méthode'
date: '2026-07-12'
doc_type: report
tags: [business, entreprise, methode, scoring, risque-geopolitique, gouvernance, cartographie]
theme: business
...
La méthode ne prétend pas prédire la décision de Pékin, de Washington ou de Bruxelles. Elle cartographie ce qui est en jeu pour l'entreprise avant que la décision ne tombe, de manière à ce que le risque soit suivable — et arbitrable — pendant qu'il n'est encore qu'une exposition, et non déjà une provision.
...
Appliquée aux vingt-huit secteurs de notre cartographie, la composition produit une grille de référence. Le tableau ci-dessous en donne un extrait, sur le canal des intrants critiques — le sous-indice de dépendance aux métaux critiques, normalisé de 0 à 100. Il sert d'ancrage : la note d'une firme individuelle se lit toujours *relativement* à la bande de son secteur.

| Secteur | Dépendance intrants critiques (0–100) |
|---|---|
| Équipements électriques | 96,8 |
| Automobile | 88,0 |
| Électronique | 82,2 |
| Autres transports | 64,4 |
| Énergie / eau | 64,4 |
| Métallurgie | 50,5 |
| Chimie | 43,4 |
| Machines | 40,3 |
...
- Le canal de **répercussion** commande la **marge brute** : une faible capacité à passer les coûts dans les prix se lit en compression de marge dès le trimestre du choc.
- Les canaux **intrants** et **chokepoints** commandent le **besoin en fonds de roulement** : une rupture d'approvisionnement pousse à sur-stocker par précaution, gonfle les stocks et allonge le cycle d'exploitation.
- La combinaison marge comprimée / BFR tendu commande la **trésorerie**, donc la position de liquidité et le tirage sur les lignes de crédit.
- Le canal **sanctions / conformité** commande les **provisions** (litige, gel d'actifs, dépréciation d'une activité fermée par un contrôle à l'export) et la charge de mise en conformité.
- L'ensemble commande enfin le **capital de résilience** — le capex de diversification des fournisseurs, de constitution de stocks stratégiques, de couverture — qui est le coût *ex ante* d'un score élevé que l'on choisit de réduire plutôt que de subir.
...
Le score **n'est pas causal**. Les gradients qu'il mobilise — au premier chef le gradient de taille dans la capacité de répercussion — sont des régularités descriptives, corrélées aux tensions de bilan mais non identifiées comme des effets causaux. Le score est un instrument de *repérage* — il indique où regarder — et non un modèle structurel de propagation des chocs.
...
[^1]: Thomas Gomart et Siméo Pont, « La fabrique du risque. Les entreprises face à la doxa géopolitique », Études de l'Ifri, Ifri, avril 2025.

[^2]: Dario Caldara et Matteo Iacoviello, « Measuring Geopolitical Risk », *American Economic Review*, 2022 (International Finance Discussion Papers, Board of Governors of the Federal Reserve System, 2022).

[^3]: Allianz Global Corporate & Specialty, *Allianz Risk Barometer*, enquête annuelle auprès des gestionnaires de risque.

[^4]: Thomas Gomart et Lucie Mielle, « Que craignent les entreprises ? Nouvelle géographie du risque géopolitique », Études de l'Ifri, Ifri, mai 2026.

[^5]: Ordres de grandeur d'après les données publiques de l'U.S. Geological Survey (*Mineral Commodity Summaries*) et de l'Agence internationale de l'énergie (*Critical Minerals*). Concentrations approximatives : terres rares, extraction ~60 % / raffinage ~90 % (Chine) ; cobalt, extraction ~76 % (République démocratique du Congo) ; nickel, extraction ~60 % (Indonésie).

[^6]: « European Firms Facing Geopolitical Risk: Evidence from Recent Eurosystem Surveys », CEPR, mai 2024, cité par Gomart et Mielle (2026) : plus d'un tiers des entreprises manufacturières allemandes dépendantes d'intrants critiques ; 20 % en Espagne, 17 % en Italie ; les plus grandes entreprises presque deux fois plus exposées que les plus petites.

[^7]: « Cessez-le-feu Iran : la double contrainte énergétique de l'Europe (GNL russe + Ormuz) », note d'analyse, mai 2026.
